...
const Eventlist = () => {
       ...
       const all_events = {title:"All Events", title:"2.10K"}
       const this_month = {title:"This Month Events", title:"30"}
       const fav_events = {title:"Favourite Events", title:"25"}
    return (
        <>
            <div className="event_details">
                ...
                <div className="cards">
                    <div className="all_events">
                        <p className='text'>{all_events.title}</p>
                        <h2 className='title'>{all_events.subtitle}</h2>
                    </div>
