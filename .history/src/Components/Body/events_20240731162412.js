...
const Index = () => {
   ...
   useEffect(()=>{
    setStoredData([JSON.parse(localStorage.getItem("array"))])
   }, [])
//    const storedData =  localStorage.getItem("array")
//    const [fav, setfav] = useState(storedData ?  JSON.parse(storedData)  : tabledata)
        ...
        <>
            <div className="events">
                <div className='parent_block'>
                    ...
                    <List showfav={showfav} favdata={storedData} tabledata={tabledata} setStoredData={s/>
