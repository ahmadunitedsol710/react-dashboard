...
const Eventlist = ({showfav, favdata, tabledata, setStoredData}) => {
    ...
    const showfilter = (slectdata) => {
        setfilterData(slectdata)
    ...
    return (
        <>
            <div className="event_details">
                <div className="evenlist">
                    <div className="main">
                        ...
                        <img src={filterIcon} alt="filter" className='filter' onClick={()=>showfilter(slectdata)} />
                    </div>
            ...
            {filterPopup && <Filterpopup slectdata={filterData}/>}
        </>
    )
}
