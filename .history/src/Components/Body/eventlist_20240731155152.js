...
const Eventlist = ({showfav}) => {
    ...
    const add_fav = (data) => {
        const isFav = faviconarray.some(favitem => favitem.id === data.id)
                            ...
                            <table>
                                <tbody>
                                    {tabledata.map((data)=>(
                                        ...
                                        <td className='details' data-label="location"> {faviconarray != null ? <img src={faviconarray.some(favitem=>favitem.id === data.id) ? emptyfav : fillfav} alt="favourite" 
