...
const Eventlist = () => {
    ...
    {id:"01",name:"Web Development",time:'12:00 AM',date:"Thu 2 Nov",location:"Bahria Intellectual Village",action:"../../Images/filter.png"},
    {id:"02",name:"Hardware",time:'12:00 AM',date:"Thu 2 Nov",location:"Bahria Intellectual Village",action:"../../Images/filter.png"}
       ]
                    ...
                    <table className="table">
                        ...
                        <tbody>
                            {tabledata.map((data)=>(
                                ...
                                <td className='details' data-label="location"> <img src={tabledata.action} alt="" /> <image/> </td>
                            </tr>
                            ))}
                        </tbody>
                    </table>
