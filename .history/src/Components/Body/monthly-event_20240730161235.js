        ...
        <div className="monthly_event">
            ...
            <div className="bottom_part">
                ...
                <div className="second_row">
                    <div className="cat_loc">
                        <div>Category: <strong>{course_details.category}</strong></div>
                        <div> <img src={pin} alt="pin" />  {course_details.location}</div>
                    </div>
                    <div className="date_time">
                        <div className="date">{course_details.date}</div>
                        <div className="time">{course_details.time}</div>
                    </div>
                </div>
            </div>
        </div>
