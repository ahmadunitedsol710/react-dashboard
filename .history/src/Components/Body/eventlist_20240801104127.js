...
const Eventlist = ({showfav, favdata, tabledata, setStoredData}) => {
    const [isFav, setIsFav] = useState(favdata.some(favItem => favItem.id === tabledata.id));
                            ...
                            <table>
                                <tbody>
                                    {showfav ? tabledata.map((data)=>(
                                        ...
                                        <td className='details' data-label="location"> <img src={isFavaAAAA ? fillfav : emptyfav} alt="favourite" 
