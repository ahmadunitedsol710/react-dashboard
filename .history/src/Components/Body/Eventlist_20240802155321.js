...
const Eventlist = ({showfav, favdata, tabledata, setStoredData}) => {
    ...
    return (
        <>
            <div className="event_details">
                <div className="evenlist">
                    <div className="main">
                        ...
                        <img src={filterIcon} alt="filter" className='filter' onClick={showfilter} />
                    </div>
                            ...
                            <table>
                                <tbody>
                                    {!showfav ? tabledata.map((data)=>(
                                        ...
                                        <td className='details' data-label="name" onClick={()=>handleRowClick(data)}>{data?.name}</td>
                                    ...
                                    favdata.map((data)=>(
                                        <tr className='body_row' key={data.id} onClick={()=>handleRowClick(data)}>
                                        <td className='index' data-label="index">{data?.id}</td>
            ...
            {showModal && <Detailpopup closeModal={closeModal} data={selectedData}/>}
            {filterPopup && <Filterpopup tabledata={tabledata}/>}
        </>
    )
}
