...
const MonthlyEvent = () => {
    const course_details = {name:"Web Development", teachers:teacher_img, category:"AI", location:"Bahria Intellectual Village", date:"Thu 2 Nov 2023", time:"12:00 am" }
    return (
        <>
        <div className="monthly_event">
            ...
            <div className="bottom_part">
                <div className="first_row">
                    ...
                    <img src={course_details.teacher_img} alt="" />
                </div>
